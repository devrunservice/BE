...
public class MyPageController {
    ...
    @ApiImplicitParam(name = "userid" , value = "주소창에 표시할 유저 id" , example = "seokhwan1")
    @ApiResponses(value = {
    ...
    @ApiImplicitParam(name = "editdata" , value = "연락처와 인증번호" , example = "{\"phonenumber\" : \"01000000000\"}")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "성공적으로 처리되었습니다"),
    ...
    @ApiImplicitParam(name = "editdata" , value = "이메일주소" , example = "{\"email\":\"http1220@kakao.net\"}")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "성공적으로 처리되었습니다"),
