...
//
//    @PostMapping("/upload")
//    public ResponseEntity<String> uploadVideos(@RequestParam("videoFileList") List<MultipartFile> videoFileList
//    										  ) throws Exception {
//        if (videoFileList.isEmpty()) {
//            return ResponseEntity.badRequest().body("동영상 파일을 선택해주세요.");
//        }
//
//        // Upload lecture thumbnail and get the URL
//        //String lectureThumbnailUrl = youTubeUploader.uploadThumbnail(lectureThumbnailFile);
//        
//        
//        List<VideoInfo> videoInfoList = new ArrayList<>();
//
//        
//        // Set other lecture properties...
//        //newLecture.setLectureThumbnail(lectureThumbnailUrl);
//
